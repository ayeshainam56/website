            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
                ...
                <div className="bg-white rounded-xl shadow-md p-6 text-center hover:shadow-lg transition-shadow">
                    ...
                    <div className="space-y-2 text-gray-700">
                        ...
                        <a
                            href="mailto:malikassociatesllc6@gmail.com"
                    ...
                    <div className="w-full lg:w-2/5 relative">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-blue-900/70 to-transparent flex items-end p-8">
                            <div className="text-white">
                                ...
                                <p>
                                    Our team is ready to guide you through your immigration journey.
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className="mt-1.5 h-4 w-4 shrink-0 cursor-pointer accent-blue-700"
                                    />

                                    <label
                                        htmlFor="smsConsent"
                                        className="text-sm leading-6 text-gray-600 cursor-pointer"
                                    >
                                        By checking this box, you agree to receive SMS
                                        messages from Malik & Associates LLC related to
                                        appointment reminders, follow-up messages, and
                                        updates or reminders regarding your inquiry or
                                        requested services. You may reply STOP to opt out
                                        at any time. Reply HELP for assistance. Message
                                        and data rates may apply. Message frequency will
